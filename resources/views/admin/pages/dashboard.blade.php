                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="statistics-details d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="statistics-title">Instructor</p>
                                        ...
                                        <div>
                                            <p class="statistics-title">Grouops</p>
                                            <h3 class="rate-percentage">68</h3>
                                        </div>
                                        <div class="d-none d-md-block">
                                            <p class="statistics-title">Group Assigned</p>
                                            <h3 class="rate-percentage">25</h3>
                                        </div>
                                        <div class="d-none d-md-block">
                                            <p class="statistics-title">Group Left</p>
                                            <h3 class="rate-percentage">68</h3>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="mt-3">
                                                                <div
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="wrapper ms-3">
                                                                            <p class="ms-1 mb-1 fw-bold">Brandon Washington
                                                                            </p>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="wrapper ms-3">
                                                                            <p class="ms-1 mb-1 fw-bold">Katherine Butler
                                                                            </p>
                                                                            <small class="text-muted mb-0">162543</small>
                                                                        </div>
                                                                    </div>
