<meta charset="utf-8">
  ...
  <link rel="stylesheet" href="{{asset('admin/asset/vendors/typicons/typicons.css') }}">
  <link rel="stylesheet" href="{{asset('admin/asset/vendors/simple-line-icons/css/simple-line-icons.css"') }}>
  ...
  <link rel="stylesheet" href="{{asset('admin/asset/js/select.dataTables.min.css') }}">
